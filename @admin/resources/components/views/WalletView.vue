      ...
      <div class="guide" v-if="nodes.filter(e => e.enabled && e.id.startsWith('commerce_')).length > 0">
        <div class="block" @click="expandCommerceSettings = !expandCommerceSettings">
          <div class="header" :class="expandCommerceSettings ? 'active' : ''">
            ...
            <div class="title">
              <div class="type">Configuration</div> CoinPayments
            </div>
          </div>
            ...
            <div class="info">
              <div class="key">
                ...
                <div class="description">
                  Register <b>self-managed</b> account on <a href="https://coinpayments.net" target="_blank">CoinPayments</a>.
                  <br>
                  Generate your API key on <a href="https://coinpayments.net" target="_blank">this page</a>.
                </div>
              </div>
              <div class="value">
            ...
            <div class="info">
              <div class="key">
                ...
                <div class="description" v-if="1==1">
                  ...
                  <br>
                  <b>https://Cryptomania.gg/api/commerce/callback</b>
                </div>
