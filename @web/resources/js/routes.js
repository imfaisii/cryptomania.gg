...
const routes = [
  ...
  { path: '/sports', component: defineAsyncComponent(() => import('./components/views/SportsIndex.vue')) },

  { path: '/casino/game/provider/:provider', component: defineAsyncComponent(() => import('./components/views/GameProvider.vue')) },
  { path: '/casino/game/category/:category', component: defineAsyncComponent(() => import('./components/views/GameCategory.vue')) },
  ...
  { path: '/amlview', component: defineAsyncComponent(() => import('./components/views/AmlView.vue')) },
