            ...
            methods: {
              ...
              onExpired() {
                ...
                const login = (callback = null) => {
                  ...
                  .then(() => { console.log('Logged in successfully!'); if(this.callback) this.callback();})
                ...
                } else { if(this.callback) { console.log('login callback exists!'); login(this.callback); } else {console.log('login callback doesnt exist!'); login();}} 
              }
            },
            template: `
              <div>
