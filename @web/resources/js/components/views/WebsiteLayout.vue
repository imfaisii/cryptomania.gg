  ...
  <div class="d-flex" v-else>
    ...
    <div class="wrapper">
      ...
      <div class="pageWrapper">
        ...
        <div class="pageContainer" style="scrollbar-color: #161b2c #0000; height: calc(100vh - 110px); overflow: auto;">
  ...
  methods: {
    ...
    addScrollToTopEvent() {
      document.querySelectorAll('a').forEach(link => {
        ...
        link.addEventListener('click', this.scrollToTop);
      });
    },
    scrollToTop(event) {
