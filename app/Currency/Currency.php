...
abstract class Currency {
  ...
  public function tokenPrice($fiat = 'eur'): float {
    try {
  ...
  public function convertUSDToToken(float $usdAmount) {
    return $usdAmount / $this->tokenPrice('eur');
  }
  ...
  public static function getAllSupportedCoins(): array {
    return [
      ...
      new Commerce\CommerceTRX(),
      new Commerce\CommerceUSDT(),
      new Commerce\CommerceUSDC(),
      new Commerce\CommerceSOL(),
      new Commerce\CommerceXRP(),
      new Commerce\CommerceBNB(),
      new Commerce\CommerceRVN(),
  ...
  public function acceptThirdParty(int $confirmations, User $user, string $id, float $sum, int $requiredConfirmations): bool {
    ...
    Log::info('acceptThirdParty-user: '.$user);
