...
class FiversCan
{
    ...
    public static function keys(): array
    {
        return [
            ...
            'apiUrl' => Settings::get('[FiversCan] API URL', 'https://fungamess.games/api/v2/cryptomania/')
        ];
    }
    ...
    public function getProviders(): array
    {
        ...
        try {
            ...
            $data = self::request('', ['method' => 'providersList'], 'post')['data'];
            ...
            foreach ($providers as $provider) {
                ...
                $data = self::request('', ['method' => 'gameList', 'provider_code' => $provider['code']], 'post')['data'];
